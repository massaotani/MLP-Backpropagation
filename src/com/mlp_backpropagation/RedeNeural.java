...
public final class RedeNeural {
    ...
    public RedeNeural(int tamCamadaEntrada, int tamSaida, int tamCamadaOculta, Double taxaAprendizado) {
        ...
        this.pesosOculta = Matrix.Randomize(this.pesosOculta, this.tamSaida, this.tamCamadaOculta);
